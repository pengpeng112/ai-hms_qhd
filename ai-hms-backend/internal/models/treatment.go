...
type TreatmentPlan struct {
	...
	PatientID         modeltypes.LegacyID `gorm:"type:bigint;not null;index" json:"patientId"`
...
type Prescription struct {
	...
	TreatmentID      int64               `gorm:"-" json:"treatmentId,omitempty"`
...
type Order struct {
	ID         string              `gorm:"type:varchar(36);primaryKey" json:"id"`
	TenantID   int64               `gorm:"type:bigint;not null;index" json:"tenantId"`
	PatientID  modeltypes.LegacyID `gorm:"type:bigint;not null;index" json:"patientId"`
...
type Treatment struct {
	...
	PatientId      modeltypes.LegacyID `gorm:"type:bigint;index:idx_treatment_patient_date;not null" json:"patientId"`
