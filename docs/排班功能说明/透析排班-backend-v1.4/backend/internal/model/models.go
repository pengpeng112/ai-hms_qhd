...
type PatientShift struct {
	...
	TreatmentStartAt     *time.Time `gorm:"column:TreatmentStartAt" json:"treatmentStartAt"` // 上机时间(决策26闸门)
	TreatmentEndAt       *time.Time `gorm:"column:TreatmentEndAt" json:"treatmentEndAt"`     // 下机时间
	StartedBy            *int64     `gorm:"column:StartedBy" json:"startedBy"`               // 上机操作人
