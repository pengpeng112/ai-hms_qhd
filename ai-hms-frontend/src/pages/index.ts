...
export { default as QCScoringPage } from './QCScoringPage'
export { default as Statistics } from './Statistics'
export { default as Settings } from './Settings'
export { default as SyncCenterPage } from './SyncCenterPage'
...
export { default as CnrdsReportPage } from './CnrdsReportPage'
export { default as MonitoringThresholds } from './MonitoringThresholds'